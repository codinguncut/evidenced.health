...
1. **The pattern worked WITHOUT weight loss or exercise.** The diet was «energy-unrestricted» and
   ...
   for CV events here is *what you eat*, not *how much you weigh*. `[INFERRED (Estruch - PREDIMED
   Mediterranean Diet 2018) from the energy-unrestricted design + the null weight-loss channel; the
   cross-trial contrast is reasoned, populations differ — see the parameter table below]`
...
- **Over-claim check:** the composite 0.70 is not read as a mortality or MI claim — the stroke-driven
  ...
  tagged `[INFERRED]` and gated behind a parameter table naming the population/comparator differences,
