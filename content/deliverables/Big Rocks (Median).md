...
mostly either small or conditional on metabolic status, and should not lead. That ordering is not an
intuition; it is what the held magnitudes say once you rank by effect size rather than by how much has
...
One honest limit on the sort: the wiki rarely holds *quantified* subgroup harm, so "mildly harmful to
the healthy" is reasoning from mechanism and held stratum-dependence, not a measured interaction. Read
bucket (b) as *conditionality*, not as evidenced harm.
...
resistance training is how you lose fat without losing disproportionate muscle. Most people already eat
