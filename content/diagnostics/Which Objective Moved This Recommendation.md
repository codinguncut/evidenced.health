...
guideline-making. [INFERRED (GRADE - Handbook; WHO - Saturated and Trans Fatty Acid Intake 2023) —
entailment from the four-determinant structure plus the worked case; neither source states the
bidirectionality.]
...
[INFERRED (NASEM - Redesigning the DGA Process) — the symmetry framing and the two-direction table are
this page's; NASEM states the constraint, not the symmetry.]
...
`[INFERRED (ESC - CVD Prevention Guidelines 2021) — the sentence and its four claims are ESC's; the
disclosure-without-weight classification and the counterfactual caution are this page's]`
