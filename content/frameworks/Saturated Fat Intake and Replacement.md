...
> [EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Rationale for SFA recommendation 3;
...
- **All-cause mortality is weaker than WHO's own summary sentence implies.** The summary says lower
  ...
  mortality." [EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Summary of evidence]
...
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Annex 6, evidence profiles 1, 5, 7 and 9]
...
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Remarks for Recommendation 3]
...
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Background] — and then files it as a
...
nutrient(s) or food(s)." [EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Research gaps]
...
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Scope] WHO's separate
...
[EXTRACTED (Willett - Nutritional Epidemiology 3e) Ch 19].
...
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Summary of evidence; Annex 6]
Willett's pooled cohorts give SFA vs carbohydrate RR **0.97** (0.81-1.16), against SFA vs PUFA RR
**1.25** (1.01-1.56). [EXTRACTED (Willett - Nutritional Epidemiology 3e) Ch 19 (p.436)]
...
fractions." [EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Summary of evidence;
...
- **Carbohydrate quality is load-bearing, and both parties say so.** WHO specifies "whole grains and
  ...
  [EXTRACTED (Willett - Nutritional Epidemiology 3e) Ch 19 (p.453)]
...
[EXTRACTED (Hooper - Saturated Fat Reduction Cardiovascular Cochrane 2020) chunk 01, Summary of findings 1]
[EXTRACTED (WHO - Saturated and Trans Fatty Acid Intake 2023) Annex 6]
...
> [EXTRACTED (Hooper - Saturated Fat Reduction Cardiovascular Cochrane 2020) chunk 01]
...
> [EXTRACTED (Hooper - Saturated Fat Reduction Cardiovascular Cochrane 2020) chunk 02]
...
[EXTRACTED (Hooper - Saturated Fat Reduction Cardiovascular Cochrane 2020) chunk 03]. It is a **monotone**
...
[[Astrup - Saturated Fats Reassessment 2020]] (a JACC narrative *State-of-the-Art Review*, 12 authors)
...
- **It AGREES with the mortality finding above.** "Most recent meta-analyses of randomized trials and
  ...
  [EXTRACTED (Astrup - Saturated Fats Reassessment 2020) chunk 01, Abstract]
...
- **A claimed SFA-sensitive subgroup (route-b, unconfirmed).** APOE4 / APOA2 gene-diet interactions
  ...
  [EXTRACTED (Astrup - Saturated Fats Reassessment 2020) chunk 01, Tailoring Dietary Saturated Fat Intake]
