...
"These modifications are neither helpful nor necessary." [EXTRACTED (GRADE - Handbook) §2]
...
- **Study design should generally not be pre-specified**, because "the studies, and therefore the
  ...
  - Worth noting against GRADE's reputation as a hierarchy: the question is framed **design-blind**,
    ...
    [INFERRED (GRADE - Handbook) — entailment from the design-not-pre-specified rule.]
- **Setting** may be folded into the population ("women in low income countries"), and matters
  ...
  resource-poor environments." [EXTRACTED (GRADE - Handbook) §2]
...
hypotheses to explain any heterogeneity found. [EXTRACTED (GRADE - Handbook) §2.1]
...
- **Named errors:** failing to include all patient-important outcomes, "e.g. adverse effects or
  ...
  guidelines target a global audience." [EXTRACTED (GRADE - Handbook) §2]
...
- **Prognostic questions take only the P and O slots** — no intervention or comparator. GRADE
  ...
  baseline risk is direct enough. [EXTRACTED (GRADE - Handbook) §2.3]
...
`[INFERRED (WHO - Saturated and Trans Fatty Acid Intake 2023) — the PICO designation and the certainty
ratings are WHO's; reading them together is this page's]`
