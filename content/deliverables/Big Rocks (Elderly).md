...
(both together: RR 0.60, a 40% lower mortality risk) [EXTRACTED @momma2022]. Weight it honestly: this is observational, self-reported, *very-low* certainty, so
...
is the driver, protein a modest RCT-grade adjunct (+2.49 kg on a 1RM, +0.30 kg lean mass) [EXTRACTED @morton2018]. Caveat specific to this stratum:
...
reduces «falls, injurious falls, and probably fractures in older adults», the strongest outcome class
the evidence carries for this age [EXTRACTED @who2020].
...
0.27-0.43) [EXTRACTED @who2020]. Sitting less is a
...
protective: paired with resistance training and higher protein, and modest, never rapid.** [INFERRED —
the muscle-preservation logic is Morton's; the "gradual not rapid" rate is mechanism, not a measured
elderly threshold; see gaps.] And keep expectations calibrated to what weight loss actually moves: for
the *liver*, sustained loss is dose-graded — «>=5%» cuts liver fat, «7-10%» improves inflammation, «>=10%»
improves fibrosis [EXTRACTED @easl2024]; for *diabetes*, an
intensive programme put «46%» of short-duration patients into remission [EXTRACTED @lean2018]. But for **hard heart attacks and strokes**, lifestyle weight loss did **not** cut
events even in a large trial (HR 0.95, 0.83-1.09) [EXTRACTED @look2013]; a 54-trial review confirms the CV-event null while finding a modest **all-cause**
mortality benefit not routed through the heart (RR 0.82, 0.71-0.95; ~6 fewer deaths per 1000) [EXTRACTED @ma2017]. So: pursue weight loss for glycaemia, liver and
...
[EXTRACTED @bplttc2021]; an intensive target
cut events and death in high-risk adults (composite HR 0.75; all-cause HR 0.73; NNT 61 over ~3.3 years)
[EXTRACTED @sprint2015]. **But age flips the thresholds and the
harms.** Intensive lowering raised hypotension, syncope, electrolyte problems and acute kidney injury
[EXTRACTED @sprint2015] — real costs when someone is already on
several drugs and prone to orthostatic falls. Guidance pulls back accordingly: lipid-lowering drops to a
"may be considered" class at «>=70» [EXTRACTED @esc2021], and statin
*initiation* is rated insufficient-evidence at «>=76 yr» [EXTRACTED @uspstf2022]. Competing risk shrinks the lifetime payoff of any prevention lever [EXTRACTED @esc2021]. **Treat on absolute risk, not a number — and here over-treatment is
...
- **Saturated fat:** reducing it cuts cardiovascular *events* (15 fewer per 1000, RR 0.83; NNT ~56 over
  ~4 years) but does **not** measurably reduce dying (mortality nulls at moderate certainty) [EXTRACTED @who2023saturated; EXTRACTED (Hooper - Saturated Fat Reduction
...
- **Free sugars:** the «<10%» limit is really a *dental* recommendation; swapping sugar for other
  carbohydrate at equal calories moves weight by 0.04 kg (null) [EXTRACTED @who2015].
- **Sodium:** lowering it drops systolic BP ~3.39 mmHg (hard outcomes only very-low certainty)
  [EXTRACTED @who2012]. Flag the flip side in the old: **over-restriction of salt (and
...
- **Red / processed meat:** the absolute cancer signal is small (~7 fewer cancer deaths per 1000 over a
  lifetime for cutting ~3 servings/week) and guidance bodies split on whether to act on it [EXTRACTED @nutrirecs2019]. It matters *more* here for a different
...
- **Alcohol:** the "moderate drinking protects" J-curve is largely an artifact (shown by bias-correction
  and by genetics) [EXTRACTED @millwood2019]. Harm
  begins earlier for women (~25 g/day) than men (~45 g/day) [EXTRACTED @zhao2023] — and at this age it interacts with the medication list and the liver.
- **Sleep:** aim for ~7-8 h. Short sleep (<7 h) carries a real ~12% higher mortality with a plausible
  ...
  shortening a long sleeper's sleep optimises a symptom, not the cause [EXTRACTED @cappuccio2010].
