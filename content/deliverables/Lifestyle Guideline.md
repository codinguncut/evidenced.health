...
1. **Don't smoke -- the largest lever, wherever it is present.** There is no good-enough dose and no
...
4. **Keep alcohol low -- less is better, with no safe threshold.** There is no good-enough dose to aim
...
[@recchia2023]. Be honest about the
...
weight and function, not on a promise about heart attacks. Where the driver is ectopic fat the reversal is
...
[@easl2024]. "Metabolically healthy obesity" is
...
[@zhao2023]. For cancer and vascular disease the
...
- **Protein and muscle (rises with age and during weight loss).** Protein supplementation augments
  resistance-training gains up to a break-point near 1.6 g/kg body weight per day (a statistically soft knee:
  1.62 g/kg, CI 1.03-2.20, p=0.079) [@morton2018];
...
[@uspstf2022]. The most intensive blood-pressure target
