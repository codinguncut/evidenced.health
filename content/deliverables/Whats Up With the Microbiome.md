...
type: deliverable
subject: What the gut microbiome actually does for your health, and which interventions change an outcome versus only a stool-composition readout
question: Which gut-microbiome health claims are supported by human-outcome evidence, which are mechanistically plausible but unproven, and which are effectively unfalsifiable — and of the levers people reach for (diet/fibre, prebiotics, probiotics, fermented foods, antibiotic avoidance, FMT), which change a patient-important outcome?
aliases: [Microbiome Deliverable, Gut Health Guide, Whats Up With the Microbiome, Microbiome Claims Appraisal]
sources: [Valdes - Gut Microbiota Nutrition and Health 2018, WGO - Probiotics and Prebiotics Global Guideline 2023, Suez - Non-Nutritive Sweeteners Glucose Tolerance 2022, WHO - Non-Sugar Sweeteners 2023, Reynolds - Carbohydrate Quality and Human Health 2019, Brown - Cholesterol-Lowering Dietary Fiber Meta-Analysis 1999, GRADE - Handbook]
confidence: medium
created: 2026-07-30
updated: 2026-07-30
---
...
specific places — but it is one of the most oversold topics in nutrition, and the reason is a single
recurring trick: **almost every study reports that an intervention "altered the microbiome," and a
change in which bacteria are present is a surrogate, not a health outcome.** A stool-census shift earns
belief only when someone follows it through to something a person actually feels — and hardly anyone
does. Sorted honestly:

- **The one big lever you already know:** diet, and within diet, **fibre**. The microbiome story
  largely *reduces to the fibre story* the evidence already supports. You do not need a supplement aisle.
- **Real, but narrow wins:** faecal microbiota transplant (FMT) for recurrent *C. difficile* infection;
  specific probiotic *strains* for specific conditions (not "probiotics" as a class).
- **Not yet:** "take a probiotic for gut health / immunity / mood," most microbiome-for-weight and
  microbiome-for-mood claims. Plausible, unproven — held open, not asserted.
- **Effectively unfalsifiable or misrepresented:** "leaky gut syndrome" as a general diet-treatable
  disease, "chronic candida overgrowth," detox/cleanse framings. Real physiology exists underneath each;
  the popular *syndrome* built on top does not.

**And rank the whole topic LOW relative to its noise.** In a mature area, attention runs *inversely* to
effect size — the big levers are settled and boring, the small ones contested and viral. The microbiome
is discussed far out of proportion to its established, outcome-level effect sizes
([[Layer 1 - Ranking Interventions for a Stratum]]).

## The one move that decides everything: composition-shift is a surrogate
...
**And the direction of the arrow is usually unknown.** This is the field's central confound, the
microbiome analogue of reverse causation: does an unhealthy microbiome *cause* the disease, or does the
...
The one study in the microbiome-adjacent literature that runs the full chain is the sweetener trial the
...
- **Saccharin and sucralose «impaired glycemic responses»**; aspartame and stevia shifted the microbiome
  ...
  a label, let alone "the microbiome."
...
- **The impressive numbers are observational.** Highest-versus-lowest fibre intake tracks **15-30% lower**
...
| Indication | Status | Note |
|---|---|---|
| Necrotizing enterocolitis (preterm neonates) | benefit — reduced NEC **and reduced death, NNT 20** | «not all probiotic preparations tested are effective»; moderate certainty |
...
| Irritable bowel syndrome | symptom benefit for *certain* strains | strain-specific |
| Pouchitis | benefit (specific preparations) | — |
| H. pylori eradication (adjunct) | reduces therapy side-effects | «the quality of the evidence was weak» |
...
- **A method warning that travels:** WGO says pooling «data on different probiotic strains without a
  ...
  work?" trap at the level of live organisms.
- **General health / immunity / mood** claims sit outside these indications — *insufficient evidence*, not a
  finding. And a swallowed probiotic is usually a **transient** passenger (it shows up in stool while you take
  it and largely washes out after), not a lasting *colonizer* that takes up residence.
...
something to attempt at home.

*(A note on the evidence: the landmark FMT-for-C.-difficile randomized trial is staged for the wiki but not
...
The guidance-null here is not a guideline body — it is the ambient wellness consensus, and this appraisal
diverges from it in a specific, repeatable way: **popular gut-health messaging sells composition-shifts and
broad-spectrum probiotics as health benefits; the evidence credits neither as such.** It oversells the
stool-census readout ("this food/supplement changes your microbiome!") as though the change were the point,
and it treats "probiotic" as a single beneficial thing rather than thousands of distinct strains with
...
- **The microbiome outcome-evidence base is largely unheld.** The fabric anchors on two gold-standard
  overviews (Valdes 2018, WGO 2023) plus the Suez template; the field's primary literature (the FMT trial, a
  Cochrane FMT review, an AGA probiotics guideline, an intestinal-permeability review) is staged, not
  ingested. Effect sizes for most sub-questions will sharpen when those land.
...
- **Open loop.** This grades the sources' reasoning for coherence and fidelity to what they say — never
  whether acting on it improves a real outcome. No operation here checks a claim against a realized outcome.
- **Appraise, do not prescribe.** This is a general appraisal, not medical advice. The real microbiome
  medical conditions named here — *C. difficile* infection, invasive candidiasis, IBD, coeliac — are clinical
  matters for a clinician; nothing here is a probiotic-strain, FMT, or antibiotic prescription.
- **General, applied per person.** The evidence speaks about strata; the weighting of outcomes and the fit to
  one person's situation happen case by case, after the fact.
- **Confidence: medium** for the held claims (fibre as the lever, probiotics-by-indication, FMT for
  *C. difficile*, the Suez causal template); **lower** for the field as a whole, which is mostly
  observational and mostly "not yet."
