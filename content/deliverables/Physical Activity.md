...
Movement is one of the largest and broadest levers a reasonably healthy person has. It moves mortality,
cardiovascular disease, several cancers, type 2 diabetes, physical function, falls, chronic pain and
mood — and no drug reproduces that whole span. A blood-pressure pill captures a blood-pressure channel;
...
prevention in older adults** [@sherrington2019]. Second,
...
**Shape is outcome-specific — cancer keeps rewarding more.** For cancer, the evidence shows no clear
plateau: more activity continues to lower risk across the studied range, so the flattening seen for
all-cause mortality does not transfer to every endpoint [@wcrf2018ter].

**The dementia signal is weaker and contested.** Inactivity associates with dementia
[@livingston2024], but a large individual-participant analysis
found the link vanished once early-disease years were removed (HR \~1.01), pointing to reverse causation
[@kivimaki2019inactivity]. The randomized multidomain trials
that could settle it bundle exercise with other levers and stay weak — no dementia-incidence benefit and
...
Prolonged sitting carries risk that is distinct from too little exercise, and it has its own dose-response
— the mirror image of the activity curve, with harm accelerating as sitting time climbs. Above roughly 8
hours a day, each additional hour of total sitting adds to all-cause mortality risk, and television
viewing is the worst-behaving form, carrying the strongest link to type 2 diabetes
...
**You can move it, and intensity moves it fastest.** Meeting activity guidelines raises fitness by roughly
...
function, independence and falls, covered below.

**Programming it is simple at the level that matters.** Any resistance training beats none by a wide
margin — the gap between doing it and not dwarfs the gaps between competing prescriptions
...
The common real question is not *whether* to move but how to allocate a limited number of minutes. The
fabric supports a few clear allocations and refuses to invent the rest.

- **Concentration is fine.** Squeezing the week's activity into one or two days ("weekend warrior")
  carries essentially the same benefit as spreading it out, once total volume is matched. An independent
  accelerometer cohort found no penalty for concentration on cardiovascular events
  [@khurshid2023], echoing the questionnaire evidence
  on mortality [@kunutsor2022].
  Different cohorts, different measurement, same conclusion — so fit the volume to your schedule.
- **Intervals buy time, not a different result.** Use higher intensity when minutes are scarce; expect a
  similar fitness gain in less time, not a bigger one [@poon2024].
- **Walking and incidental movement carry real volume.** Steps count toward the mortality curve, and
  moving more at any intensity while sitting less is itself the lever — this is the light, incidental
  activity that fills most of the dose, not structured cardio [@ekelundacc2019].
- **Do not exercise as your main weight-loss tool.** The body compensates for a fair share of the calories
  burned — roughly a fifth to a quarter on average, rising with longer programs and higher body fat
  [@riou2015] [@careau2021].
  Exercise is a weak lever on the scale but a strong one on visceral fat per unit of deficit
  [@recchia2023].

**A wearable is a small nudge, best bundled.** Activity trackers add a modest, low-certainty amount of
movement — on the order of a few hundred extra steps a day — with durability unproven; they help most
when paired with human coaching rather than used alone
[@brickwood2019wearable]. The
one fixed-budget question the wiki cannot answer is the exact HIIT-versus-moderate trade at matched
minutes for hard outcomes — that magnitude is not held, and this page does not manufacture it.


## Targets worth measuring, none worth chasing blindly

Three numbers place a person in a risk stratum, and all three carry the same caveat: they predict
outcomes but are not proven to improve them when you push on the number itself.

- **Fitness (VO2max)** is the strongest of the three and does respond to training, but it is heritable and
  disease-sensitive [@mandsager2018].
- **Grip strength** predicts all-cause and cause-specific mortality broadly and cheaply — about 16-20%
  higher mortality per 5 kg lower grip — and adds discrimination to an office risk score with no blood
  test [@celismorales2018]. It is a measurement, not a
  training target. Where sarcopenia is the concern, screening leads on grip and a chair-rise — probable
  sarcopenia flagged below \~27 kg (men) / 16 kg (women), imaging only confirmatory
  -> [[Sarcopenia Definition and Diagnosis]].
- **Muscle mass** predicts mortality too, and not only as a shadow of strength, though the effect is small
  [@santana2021].

So measure these to check whether the *lever* — the activity — is working, and to size someone's baseline
...
safely-challenging balance and functional work, not exercise in general — and resistance training *alone*
did not reduce falls (its estimate sat above 1). Walking programs are not fall prevention either. The
absolute benefit is largest in those at highest fall risk, but the effect reaches the general community
too.
...
**Movement is also safe and useful for painful joints.** Across chronic pain conditions, exercise does not
worsen the condition and probably helps function a little, at low certainty — which directly counters the
old advice to rest [@geneen2017chronicpain].
For overweight adults with knee osteoarthritis, weight loss plus exercise beats either alone on pain and
function, and exercise is safe for the arthritic joint [@messier2013idea]
