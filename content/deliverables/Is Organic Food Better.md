...
differences between organic and conventional food are, how large they are against your whole diet, and
whether it is the *certification* or some *underlying exposure the label only partly captures* that is
doing the work. It is not advice for one person: your budget and priorities enter later, when you weigh
this against everything else. And it appraises **health only**. Many people buy organic for the
...
The first move is to refuse the premise that *natural = healthier*. Provenance — how a food was produced —
argues health in **neither** direction. *Organic, therefore better* is exactly as unwarranted as
*processed, therefore worse*; both need outcome evidence, not a story about origin. This matters because
the word *organic* invites you to treat it as a single thing with a single answer, and it is not.

The *organic* label is a **certification bundle**: no synthetic pesticides, no synthetic fertiliser, no routine
antibiotics, welfare rules, and — often, but not always — pasture or outdoor access. The health question
therefore splits into separate sub-questions, each with its own evidence and its own effect size. The rest
of this appraisal answers them one at a time, because bundling them back into a verdict on the word is
where the reasoning goes wrong. -> [[Is the Food Category Doing Any Work]]
...
about 48% lower in organic crops, though the confidence interval on that percentage was wide (-48%, 95% CI
-112 to 16), so the statistically significant cadmium result rests on a different (standardized-mean-
...
So lower residues is a legitimate reason to *prefer* organic on a precautionary basis if you value that,
but it is not a proven health benefit. **The one clean safety signal Smith-Spangler did find was
elsewhere:** bacteria resistant to three or more antibiotics were commoner on conventional chicken and
pork (risk difference 33%), while *E. coli* contamination did not differ by farming method
[@smithspangler2012].

## Sub-question 2 — nutrient content: small differences, running both ways

The nutrient story looks pro-organic at the compositional level and evaporates once someone weighs it
against total diet. Baranski found antioxidants and (poly)phenolics **substantially higher in organic** —
phenolic acids +19% (95% CI 5, 33), flavanones +69% (13, 125), stilbenes +28%, flavones +26%, flavonols
+50%, anthocyanins +51%
[@baranski2014].
...
[@smithspangler2012]. A higher
polyphenol content in the food does not translate into a measured nutritional advantage for the person.

**And the differences are not uniformly in organic's favour** — which is worth stating precisely because a
uniformly favourable picture would be a tell that the appraisal had a thumb on the scale. Organic milk was
higher in alpha-tocopherol (vitamin E) and iron but **lower in iodine and selenium**
[@srednickatober2016milk]. The honest reading
is a small, mixed-direction difference that does not move the needle against your total intake.

## Sub-question 3 — the cattle case: the label tracks the feed, not the certificate

This is the sub-question where the label and the thing that actually matters come apart, and it is the most
useful one to understand. **Organic milk and meat do carry a more desirable fat profile — and the driver is
pasture, not the certificate.**

For milk (Srednicka-Tober, 170 studies), total saturated and monounsaturated fat did not differ between
organic and conventional, but the omega-3 fats did: total n-3 PUFA +56% (95% CI 38, 74), alpha-linolenic
acid +69% (53, 84), the long-chain marine-type n-3 (EPA+DPA+DHA) +57% (27, 87), and conjugated linoleic
acid (CLA) +41% (14, 68) [@srednickatober2016milk]. For meat (67 studies), saturated fat was similar, monounsaturated slightly lower, and n-3 PUFA about
47% higher in organic (95% CI 10, 84); heterogeneity was high and was explained largely by differences
...
reason for differences in FA profiles»
[@srednickatober2016meat].

The consequence for what you buy is direct. The causal lever is **grass vs grain**, and organic
...
intake, so whether a +40-70% relative lift is a meaningful absolute gain against total diet is genuinely
unestablished, not known to be trivial. And **the animal-product food associations carry their own
confounding** — whole-fat-dairy and unprocessed-meat eaters differ systematically from others — so this is
a compositional finding about the fat in the product, not a proven outcome benefit from eating it.

## Sub-question 4 — hard outcomes: one confounded cohort, no trial

Does organic eating actually make you healthier or help you live longer? This is the hardest to establish
and the weakest link. There is **no randomised trial** — you cannot blind or randomise a lifetime of
organic eating, and self-reported diet carries measurement error large enough to blur the very comparisons
that would settle it -> [[Measurement Error in Dietary Assessment]].

The largest observational study is Baudry's NutriNet-Sante cohort — 68,946 French adults, 1,340 incident
cancers — which found that «high organic food scores were inversely associated with the overall risk of
...
15.1 g/day) and red meat (48.7 -> 31.4 g/day) fell
[@baudry2018]. Organic buying is a marker
of overall diet quality and social position, both of which independently predict cancer — which is why an
inverse association here is expected whether or not the label does anything.
...
- **Residues:** genuinely lower on organic (about four times lower incidence in crops; contamination risk
  difference 30%), but conventional residues mostly sit below regulatory limits and no evidence ties the
  difference to a health outcome. A surrogate, not a demonstrated benefit — real grounds for a precautionary
  preference, not a proven health win.
...
- **Animal-product fats:** a real +40-70% relative lift in omega-3 and CLA — but a **feed (pasture) effect**
  the organic label only partly captures, and of unestablished absolute size against total diet. Steer by
...
so much attention is itself a mild anti-signal: in a mature area the large, settled effects generate little
discussion while the small, contested ones generate products and content. This appraisal **agrees with the
mainstream position**: buy organic if you value the non-health reasons for it, but do not expect a
documented population-level health benefit — the measured differences are real, and their health
consequence is unproven.
...
those can be perfectly good reasons. This appraisal simply does not price them: it holds no carbon, water,
or welfare data and would be inventing a verdict if it pretended to. The pattern is the same one that shows
up when people cut red and processed meat for reasons that are partly ethical or environmental rather than
purely about their own health -> [[Should Adults Reduce Red and Processed Meat]] — the health question and
the values question are separate axes, and only the first is answered here. What you do with the second is
yours, weighed against your budget and priorities.
...
- **Open loop.** This grades internal coherence and fidelity to its sources, never validity against the
  ...
  recommendation.
- **Appraise, not prescribe.** This names what the evidence shows on health; it is not a shopping rule or a
  budgeting rule, and it screens no one's individual situation.
